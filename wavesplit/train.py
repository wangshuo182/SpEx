...
from wsj0_mix_source_spkid import Dataset
...
parser.add_argument("--exp_dir", default="exp/wavesplit", help="Full path to save best validation model")
...
class WavesplitTrainer(System):
    ...
    def training_step(self, batch, batch_nb):
        ...
        self.log("loss", tot_loss, logger=True)
...
def main(conf):
    ...
    val_set = Dataset(
        "/media/asus/DATADISK/DATASETS/wsj0-mix/2speakers/wav8k/min/wav_list_cv.txt",
        segment=1.0        
        # conf["data"]["task"],
        # sample_rate=8000,
        # segment=conf["data"]["segment"],
...
if __name__ == "__main__":
    ...
    with open("wavesplit/local/conf.yml") as f:
